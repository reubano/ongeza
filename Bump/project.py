...
from bump.changelog import Changelog
from bump.release import Release
from bump.git_utils import *
from bump.shell_utils import info, fail
from bump.shell_utils import write, shell, choice
from bump.package_utils import *
...
class Project(object):
    """
    base class representing a bump configuration object.
    """
    ...
    def __init__(self, config=None):
        """
            :param config: instance of a BumpConfig object
        """
        self.config = config
    ...
    sorry, we're still ghetto-riggin this script along.. workin on it..""")
            ...
            # https://github.com/gregorynicholas/bump/issues/2
    ...
    def setup_initial_release(self):
        ...
        """
        if not choice("""
    do you want bump to setup the initial release?"""):
