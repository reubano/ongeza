"""
    ...
    configuration for bump projects.
...
class BumpConfig(dict):
    """
    class representing a bump configuration object.
    """

    DEFAULT_CONFIG_FILE = ".bump.yaml"
...
{summaries}
    ...
    def find_config_file(self, config_file):
        """
        searches the current working dir ./ and the home dir ~/ for '.bump.yaml'
        """
        if config_file:
